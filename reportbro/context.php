            ...
            if ($parameter_index == -1) {
                ...
                if ($c == '}') {
                    ...
                    if ($parameter->type == ParameterType::map()) {
                        ...
                        if ($parameter && is_array($map_value)) {
                            $value = array_key_exists($field_name, $map_value) ? $map_value[$field_name] : '';
                        }
                    } else {
            ...
            if ($used_pattern) {
                try {
                    ...
                    if ($pattern_has_currency) {
                        $value = str_replace('$', CURRENCY[$this->pattern_currency_symbol], $value);
                    }
                    $rv = $value;
                } catch (Exception $e) {
